...
namespace Maze.Graphics
{
    public class RenderTargets
    {
        ...
        {
            Color = new RenderTarget2D(Maze.Instance.GraphicsDevice, 1920, 1080, false, SurfaceFormat.Color, DepthFormat.Depth24Stencil8, 0, RenderTargetUsage.PreserveContents);
            Depth = new RenderTarget2D(Maze.Instance.GraphicsDevice, 1920, 1080, false, SurfaceFormat.Single, DepthFormat.Depth24Stencil8, 0, RenderTargetUsage.PreserveContents);
